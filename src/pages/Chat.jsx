...
import { Menu, Paperclip, Mic, Send, Copy, Sparkles, User, Bot, Trash2 } from 'lucide-react';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {user?.avatar ? <img src={user.avatar} style={{width:'100%', height:'100%'}} /> : <User size={20} style={{margin:'5px'}} />}
        </div>
      </div>
